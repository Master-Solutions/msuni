		...
		return (
			<React.Fragment>
				...
				<AppLayout.Container
					...
					<AppLayout.Header bgColor={this.props.headerBgColor || DefaultAppLayout.headerBgColor}>
						<div>{this.props.headerLeft}</div>
						<div>{this.props.headerCenter}</div>
						<div>{this.props.headerRight}</div>
					</AppLayout.Header>
					<AppLayout.Sidenav bgColor={this.props.sidenavBgColor || DefaultAppLayout.sidenavBgColor}>
						<div>{this.props.sidenavTop}</div>
						<div>{this.props.sidenavCenter}</div>
						<div>{this.props.sidenavBottom}</div>
					</AppLayout.Sidenav>
					<AppLayout.Main bgColor={this.props.mainBgColor || DefaultAppLayout.mainBgColor}>
						{this.props.header}
						{this.props.children}
					</AppLayout.Main>
					<AppLayout.Footer bgColor={this.props.footerBgColor || DefaultAppLayout.footerBgColor}>
